namespace Checkout
{
    public class ApiUrls
    {
        ...
        private static string _ItemsUri;
        private static string _ItemUri;
        ...
        public static string Item
            => _ItemUri ??
            (_ItemUri
            = string.Concat(AppSettings.LocalBaseApiUri, "/Carts/Items"));
        public static string Items
            => _ItemsUri ??
            (_ItemsUri
            = string.Concat(AppSettings.LocalBaseApiUri, "/Carts/Items/{0}"));
    }
}